...
syntax match elegantCommand  /\V&aperture_input/
syntax match elegantCommand  /\V&awe_beam/
syntax match elegantCommand  /\V&bunched_beam/
syntax match elegantCommand  /\V&bunched_beam_moments/
syntax match elegantCommand  /\V&change_end/
...
syntax match elegantCommand  /\V&error/
...
syntax match elegantCommand  /\V&fit_traces/
...
syntax match elegantCommand  /\V&include_commands/
...
syntax match elegantCommand  /\V&optimization_constraint/
...
syntax keyword elegantName      ehkick
syntax keyword elegantName      ekicker
syntax keyword elegantName      else
...
syntax keyword elegantName      ksbend
syntax keyword elegantName      ksext
syntax keyword elegantName      lgbend
syntax keyword elegantName      line
