...
C output arrays
        DIMENSION EE_O(5001),LAMDA_O(5001),XPMM_O(5001)
        DIMENSION YPMM_O(5001),RRAD_O(5001),POWER_O(5001)
        DIMENSION L1_O(5001),L2_O(5001),L3_O(5001),L4_O(5001),EI_O(5001)
        DIMENSION SPEC1_O(5001),SPEC2_O(5001),SPEC3_O(5001)
...
C        character*78    infile,outfile
     ...
     $  SPEC1(5001),SPEC2(5001),SPEC3(5001),SPEC0(5001),WK(5001)
        COMMON/OUT1/NEE,MIN_I,MAX_I,II1(3001),II2(3001),
     $       II(3001),IMAX,IHARM5
        COMMON/OUT2/EE(5001),L_LAMDA(5001),RADMAX,
     $       X_P(3001),Y_P(3001),EI1(3001),
     $       POWER1(5001),RRAD(5001),PDTOT,PTOT1,FTOT,
     $       LL1(5001),LL2(5001),LL3(5001),LL4(5001)
