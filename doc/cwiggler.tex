...
tunes from tracking and Twiss parameter calculations.  Presently this
works only for horizontal wigglers.
...
expansion given may not be appropriate.  Here, we summarize the form of the
