...
\item The \verb|WAKE| and \verb|TRWAKE| elements now support bunch-by-bunch calculations.
...
\item The \verb|sdds_beam| command has two new parameters, \verb|track_pages_separately| and \verb|use_bunched_mode|, which clarify the handling of multi-page
  input files and allow invoking bunched-mode calculations with \verb|LRWAKE|, \verb|WAKE|, and \verb|TRWAKE|.
...
This includes the {\tt LRWAKE}, {\tt WAKE}, and {\tt TRWAKE} elements.
