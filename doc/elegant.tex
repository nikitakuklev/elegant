...
\item Corrected the handling of the DC term for \verb|ZTRANSVERSE|. The code was ignoring the real part of the impedance
...
\begin{itemize}
\item The handling of the DC term in \verb|ZLONGIT| was modified to conform to the FFT conventions used by \verb|sddsfft|.
  In particular, the term is multipled by two internally. The new script \verb|wake2impedance| illustrates how to 
  create a longitudinal impedance from a wake function using \verb|sddsfft|.
\end{itemize}

\subsection{New and Modified Commands}
\begin{itemize}
\item Added more controls for mathematica-compatible output from the \verb|matrix_output|.
\end{itemize}
