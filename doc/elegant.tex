...
\item notes: 
	\begin{itemize}
	\item Any number of these commands may be given.
	\item This command is rarely needed, but can provide improved {\em parallel} performance in cases where large numbers
          of non-transforming elements (e.g., \verb|MARK| or \verb|MONI| elements) exist in a beamline.
          Using the \verb|show_element_timing| flag in \verb|run_setup| can allow determining if this 
          will help.
	\end{itemize}
\end{itemize}
