...
\section{Highlights of What's New in Version 24.2}
...
\item The expressions for the second-order resonance driving terms (\verb|twiss_output| command) were corrected. The original expressions, obtained from \cite{Bengtsson}, were
determined to be in error. Thanks to J. Choi (BNL) for pointing this out. C. X. Wang (APS) derived the new expressions.
...
Contributors to related programs include M. Borland, R. Dejus, L. Emery, A. Petrenko, H. Shang, Y. Wang, and
A. Xiao.
