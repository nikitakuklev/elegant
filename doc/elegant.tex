...
\author{Program Version 34.3.0\\Advanced Photon Source\\Michael Borland, Tim Berenc\\ \date{\today}}
\maketitle
...
Here is a summary of what's changed since release 34.12.
...
\item The \verb|CCBEND| element had incorrect signs for the odd-order systematic multipoles when the bending
  angle was negative. R. Lindberg (APS) helped identify this problem.
...
\end{equation} is also computed. (Note that some programs, e.g., TRACY and MAD, define these quantities
with a square-root inside the logarithm \cite{BuesingPC}. This changes the values by a factor of 2.)
