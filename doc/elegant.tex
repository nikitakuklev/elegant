...
\item A new element, \verb|KQUSE|, was added.  It combines quadrupole and sextupole fields.  V. Sajaev (ANL) 
  requested this.
\item A new element, \verb|UKICKMAP|, was added.  It provides simulation of undulators using RADIA kick maps.
  A script (\verb|km2sdds|) is provide to translate the RADIA output into SDDS for use by \verb|elegant|.
  This was requested by W. Guo (BNL), who also assisted with the implementation.
...
\item A new script, \verb|km2sdds|, was added.  This script translates RADIA kick maps into SDDS format for 
 use by \verb|elegant|.
\end{itemize}
