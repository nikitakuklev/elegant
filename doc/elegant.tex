...
and references, see the specific entries in the manual.  Several minor bugs
were fixed.  There were also several significant feature enhancements.
...
\begin{itemize}
\item A new program, \verb|csrImpedance|, was added. This program, written by Y. Wang and H. Shang (ANL), 
 computes the shielded steady-state CSR impedance in a form that can be immediately used with \verb|elegant|'s
 \verb|ZLONGIT| element.
\end{itemize}
