...
\item The \verb|LSRMDLTR| element now supports a laser time profile and also synchrotron radiation.  This was
  requested by D. Xiang (SLAC).  The element is also parallel-capable now.
