...
\item Z. Duan (IHEP) reported an issue with misalignment methods 1 and 2 for \verb|CSBEND| elements when
  ...
  a \verb|TILT| is imposed on the misaligned element in all cases except \verb|CCBEND|.
  In addition, we added the ability to selected either the linearized or exact Venturini algorithm.
\end{itemize}
