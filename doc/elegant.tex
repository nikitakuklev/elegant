...
\item The \verb|ion_effects| command was improved in several ways: 
  ...
  \item The new \verb|ion_histogram_max_bins| parameters allows restricting the maximum number of bins; it defaults to 5,000.
...
The user is strongly advise to study the ion histograms by using the \verb|ion_histogram_output| parameter to request
this data.
