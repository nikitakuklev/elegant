...
\author{Program Version 2021.3\\Advanced Photon Source\\Michael Borland\\ \date{\today}}
\maketitle
...
\section{Highlights of What's New in Version 2021.3}

Here is a summary of what's changed since release 2021.2.  Historical change logs are collected in Section
\ref{sect:changeLog}.
...
\begin{itemize}
\item The lattice parser would crash when a single reflected element appeared with a quoted  name.
  This was fixed.
\end{itemize}
...
Contributors to {\tt elegant} include M. Borland, M. Carla', N. Carmignani, AJ Dick, M. Ehrlichman, L. Emery, W. Guo, R. Lindberg,
