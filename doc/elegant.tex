...
\author{Program Version 2019.4\\Advanced Photon Source\\Michael Borland, Tim Berenc\\ \date{\today}}
\maketitle
...
\section{Highlights of What's New in Version 2019.4.0}
...
\item The \verb|ILMATRIX| element lacked path-length terms related to the betatron amplitude, and 
  ...
  by forum user Teresia. This was improved.
\item Fixed bug in back-tracking for \verb|SBEN| elements with nonzero values for \verb|HGAP| and \verb|FINT|.
  This bug was reported by Y. Park (UCLA).
\end{itemize}
