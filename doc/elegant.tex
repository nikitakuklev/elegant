...
\author{Program Version 2019.1.1\\Advanced Photon Source\\Michael Borland, Tim Berenc\\ \date{\today}}
\maketitle
...
\section{Highlights of What's New in Version 2019.1.1}
...
\item The \verb|UKICKMAP| element now has a flag to indicate that the kickmap is for a single period of an insertion
  device, which makes it easier to configure.
\end{itemize}
