...
\author{Program Version 32.1.0\\Advanced Photon Source\\Michael Borland, Tim Berenc\\ \date{\today}}
\maketitle
...
\section{Highlights of What's New in Version 32.1}

Here is a summary of what's changed since release 32.0.
Note that historical changes logs are appended to the end of this manual.
...
\item Compared to previous versions, the lost-particle data file (\verb|losses| file requested by the \verb|run_setup|
  command) will show changes in the order in which particles are recorded. This was a result of reworking the code for
