...
\author{Program Version 34.2.0\\Advanced Photon Source\\Michael Borland, Tim Berenc\\ \date{\today}}
\maketitle
...
\section{Highlights of What's New in Version 34.2.0}
...
\end{equation}
\item The \verb|coupled_twiss_output| command would sometimes crash when \verb|calculate_3d_coupling=0|. This was fixed.
\end{itemize}
...
\item \verb|mpi_io_force_file_sync|  --- If non-zero, \verb|Pelegant| will perform a file synchronization after writing each row of
  an SDDS file. This can significantly impact performance, but can solve problems on some filesystems that result in corrupted files
