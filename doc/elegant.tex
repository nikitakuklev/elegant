...
\author{Program Version 2019.3\\Advanced Photon Source\\Michael Borland, Tim Berenc\\ \date{\today}}
\maketitle
...
\section{Highlights of What's New in Version 2019.3.0}
...
\item DA trimming (to make the \verb|xClipped| and \verb|yClipped| columns, as well as the \verb|Area| parameter)
  was not working properly in the parallel version. This was fixed. In addition, the algorithm was improved for
...
\item The \verb|ion_effects| command was improved in several ways: 
  \begin{itemize}
  \item The distribution fitting parameters for the serial version are automatically adjusted to improve fitting,
    so that it is comparable to the fitting used by the parallel version.
  \item The \verb|ion_histogram_max_bins| was added to allow restricting the maximum number of bins; it defaults to 100,000.
  \item The \verb|freeze_ions_until_pass| and \verb|freeze_electrons_until_pass| to allow ``freezing'' the motion of the
