...
\item \verb|fit_residual_type| --- Residual type for bigaussian fitting. The default is \verb|"rms-deviation"| and seems to
  give the best fits to the ion core. Other options are \verb|"sum-absolute-deviation"| and \verb|"max-absolute-deviation"|. 
