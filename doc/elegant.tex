...
\verb|halton_optimized| uses the improved halton sequence 
(Alogrithm 659, Collected Algorithm from ACM. Derandom Algorithm is added
   by Hongmei CHI (CS/FSU)). It avoids the banding probleam automitically and
the \verb|halton_radix| values are ignored here.
