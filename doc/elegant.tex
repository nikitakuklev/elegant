...
\begin{itemize}
\item {\tt touschekLifetime:} Added ability to limit momentum aperture using the supplied rf voltage and harmonic number, following a 
  discussion with R. Bosch (SRC).
