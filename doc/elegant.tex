...
\author{Program Version 2020.1\\Advanced Photon Source\\Michael Borland, Tim Berenc\\ \date{\today}}
\maketitle
...
\section{Highlights of What's New in Version 2020.1.0}

Here is a summary of what's changed since release 2019.4.0.
...
\item The \verb|ETILT| parameter of the \verb|CSBEND| and \verb|CSRCSBEND| elements was not implemented correctly. Although
  the magnitude of the trajectory error was correct, it had the wrong sign compared to the dynamic effects (e.g., vertical 
  dispersion). This bug was reported by G. Penn (LBNL), and has been fixed.
...
\item The handling of the DC term in \verb|ZTRANSVERSE|. The code was ignoring the real part of the impedance
...
\item The handling of the DC term in \verb|ZLONGIT| was corrected.  In particular, the term is needed to be multipled by 
