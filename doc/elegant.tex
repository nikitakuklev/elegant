...
\author{Program Version 23.X\\Advanced Photon Source\\Michael Borland\\ \date{\today}}
\maketitle
...
\section{Highlights of What's New in Version 23.X}
...
\begin{itemize}
\item In some cases, the {\tt failed} semaphore file would not be created when a run failed.  This
  has been rectified.
\end{itemize}
