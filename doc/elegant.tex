...
\item The \verb|FSE_DIPOLE| and \verb|FSE_QUADRUPOLE| values were being left at the user-defined values when determining
  the reference trajectory when \verb|REFERENCE_CORRECTION=1|. This is bug was reported by G. Penn (LBNL), and has been
  fixed.
...
\begin{itemize}
\item The handling of the DC term in \verb|ZLONGIT| was corrected.  In particular, the term is now multipled by two internally. 
  The new script \verb|wake2impedance| illustrates how to create a longitudinal impedance from a wake function using \verb|sddsfft|.
\end{itemize}
