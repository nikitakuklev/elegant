...
\begin{itemize}
\item The \verb|LRWAKE| element now supports long-range quadrupole wakes. R. Lindberg (APS) provided helpful
  discussion in this implementation.
\item The \verb|ILMATRIX| element now supports second-order tune shift with amplitude as well as path-length dependence
  on amplitude.
