...
\author{Program Version 2023.2\\Advanced Photon Source\\Michael Borland\\ \date{\today}}
\maketitle
...
\section{Highlights of What's New in Version 2023.2}
...
\item \verb|field_calculation_method| --- By default, the fields are computed on the
  ...
  Finally, once can make use of a Poisson solver by setting \verb|field_calculation_method| to \verb|"poisson"|.
