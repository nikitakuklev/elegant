...
\item The parameters file created with the parameters field of \verb|run_setup| does not contain
...
\item In past versions, the {\tt RFDF} element had a very strange way of defining the RF phase
  ...
  being simply the phase of the first kick the beam receives.
...
\item The algorithm for the \verb|momentum_aperture| command was changed, to address reproducibility issues
 ...
 consistent results. Unfortunately, this change is not backward compatible.  Thanks to P. Chou (NSRRC) for
