...
\begin{itemize}
\item The unified warning system has now been completed. All warnings from elements go through this
...
\item The \verb|global_settings| command has a new parameter, \verb|warning_limit|, the controls how many similar
  warnings will be shown in detail before such warnings are suppressed.
