...
\item A new command, \verb|insert_elements|, was added by A. Xiao (ANL).  It allows inserting elements into a lattice at many locations. This is a convenient way to add elements to a lattice without modifying the lattice file.
