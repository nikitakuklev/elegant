...
\author{Program Version 34.5.0\\Advanced Photon Source\\Michael Borland, Tim Berenc\\ \date{\today}}
\maketitle
...
\item The \verb|CCBEND| element now was a \verb|YAW| parameter that permits changing the entrance and exit
  ...
  for soft-fringe effects, as well as multipoles from octupole to 18-pole.
...
\begin{itemize}
\item The \verb|matrix_output| command has a new parameter, \verb|print_element_data| that controls whether the
  element data is printed in addition to the matrices.
\end{itemize}
