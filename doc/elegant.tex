...
Here is a summary of what's changed since release 2019.1.0.
...
\item The \verb|CSBEND| and \verb|SBEND| elements now support separate fractional strength errors (FSE) for
