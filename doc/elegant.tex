...
\author{Program Version 16.1.1\\Advanced Photon Source\\Michael Borland\\ \date{\today}}
\maketitle

\section{Highlights of What's New in Version 16.1.1}

This is mostly a minor bug-fix release. The most significant change as
of version 16.1 is that a parallel version ({\tt Pelegant}) is
supported in this release.  All single-particle dynamics have been parallelized.
