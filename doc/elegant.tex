...
\item The \verb|SCRIPT| element would be treated as a drift space if
 ...
 by default uses tracking to determine the matrix.  {\em This may
 impact the operation of some runs, but can be turned off using the
 \verb|DRIFT_MATRIX| parameter.}
\end{itemize}
