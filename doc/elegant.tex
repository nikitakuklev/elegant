...
\author{Program Version 2021.4\\Advanced Photon Source\\Michael Borland\\ \date{\today}}
\maketitle
...
\section{Highlights of What's New in Version 2021.4}

Here is a summary of what's changed since release 2021.3.  Historical change logs are collected in Section
\ref{sect:changeLog}.
...
\item The \verb|rf_setup| command now does a better job of setting the rf frequency in the presence of a closed
  ...
  turn from radiation integrals and tracking.
\end{itemize}
