...
\item The \verb|CSRDRIFT| element was excluded from element division.  This has been corrected.  Y. Ding (SLAC)
  reported this.
\item The \verb|SCRIPT| element would be treated as a drift space if matrix concatenation was requested in
 \verb|run_setup|.  This has been corrected.  W. Guo (BNL) reported this.
\end{itemize}
