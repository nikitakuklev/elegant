...
\begin{itemize}
\item The \verb|BGGEXP| element now supports both normal and skew components. R. Lindberg (APS) implemented most of the
  code for this. 
...
\item The \verb|ETILT_SIGN| parameter for \verb|CSBEND|, \verb|CSRCSBEND|, \verb|RBEN|, and \verb|SBEN| now defaults
  to \verb|1|. The previous default of \verb|-1|, for backward compatibility, is potentially confusing.
\end{itemize}
...
\begin{itemize}
\item The \verb|computeRGGGE| program was added, allowing computation of a generalized gradient expansion for
  use with \verb|BGGEXP| based on field data on a rectangular boundary. The code was developed by R. Lindberg and
  R. Soliday (APS).
\end{itemize}
