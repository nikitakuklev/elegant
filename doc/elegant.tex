...
\item The \verb|analyze_map| command can now determine the nonlinear transport matrix up to third order based on tracking data,
  using the method described in \cite{Borland_thesis}.
...
\bibitem{KHwang}
  K. Hwang and S. Y. Lee, ``Dipole fringe field thin map for compact synchrotrons, submitted to PRSTAB; K. Hwang, ``On intrinsic nonlinear particle 
