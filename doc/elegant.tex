...
\begin{itemize}
\item Added the \verb|BMXYZ| element for integration through 3D field maps. At present, it is restricted to
  straight elements as no coordinate transformations are performed.
\item Added the \verb|FACTOR| parameter for \verb|FTABLE|, to allow scaling fields by a numerical value.
