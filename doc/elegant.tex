...
\item The \verb|EDRIFT|, \verb|CSBEND|, \verb|KQUAD|, \verb|KSEXT|, and \verb|KOCT| elements can now be
  used with back-tracking (see \verb|run_setup|).
\end{itemize}
...
\item \verb|back_tracking| --- If nonzero, then back-tracking is performed. The beamline is reversed in
  ...
  present, including \verb|CHARGE|, \verb|CSBEND|, \verb|DRIF|, \verb|EDRIFT|, \verb|HMON|, 
  \verb|KOCT|, \verb|KQUAD|, \verb|KSEXT|, \verb|MARK|, \verb|MONI|, \verb|QUAD|, \verb|RFCA|, 
