...
\author{Program Version 2022.0\\Advanced Photon Source\\Michael Borland\\ \date{\today}}
\maketitle
...
\section{Highlights of What's New in Version 2022.0}
...
\item \verb|input| --- Name of SDDS file containing obstruction data. The file must contain two columns, \verb|Z| and 
  ...
  \end{itemize}
  The file may optionally contain another parameter:
  \begin{itemize}
    \item \verb|CanGo| --- This integer parameter can be used to distinguish between ``no-go'' and ``can-go'' 
      ...
      lost. If this parameter is specified and the value is non-zero, the contour defines a region inside which
      particles can propagate. This is typically used to override part of a no-go region.
  \end{itemize}
