...
\section{Highlights of What's New in Version 25.3.X}

Here is a summary of what's changed since release 25.2:
...
\begin{itemize}
\item Added the \verb|tune_footprint| command, which allows computing and optimizing the momentum and amplitude tune footprints.
\end{itemize}
...
\begin{itemize}
\item \verb|FP.nuxChromaticSpread|,\verb|FP.nuyChromaticSpread| --- Spread in tunes due to chromaticity.
\item \verb|FP.deltaLimit| --- Minimum of absolute values of positive and negative $\delta$ limits. 
\item \verb|FP.nuxAmplitudeSpread|, \verb|FP.nuyAmplitudeSpread| --- Spread in tunes due to amplitude.
\item \verb|FP.xSpread|, \verb|FP.ySpread| --- Spread in x and y values.
\end{itemize}
Typically, one strives to minimize \verb|FP.nuxChromaticSpread|,\verb|FP.nuyChromaticSpread|, \verb|FP.nuxAmplitudeSpread|, \verb|FP.nuyAmplitudeSpread| 
while maximizing \verb|FP.deltaLimit|, \verb|FP.xSpread|, and \verb|FP.ySpread|.
I.e., one wants the maximum stable region for momentum and position deviations with the minimum spread in tunes.
