...
Here is a summary of what's changed since release 28.2:

\subsection{Bug Fixes for Elements}

\begin{itemize}
\item Fixed a bug in the \verb|MATRX| element that would crop up in multi-step runs, causing a crash or lock-up.
