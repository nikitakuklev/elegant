...
\item {\tt LSRMDLTR} --- A laser/undulator beam modulator, using a numerically-integrated
        ...
        the development.
\item {\tt TAYLORSERIES} --- A generate Taylor-series map specified as an SDDS file.
        This element was implemented by L. Emery (ANL), but has yet to be fully
        integrated into {\tt elegant}.
...
\item Fixed problem with skewed selection of momentum offset values for higher-order
 chromaticity when the number of points was not 5.
