...
\author{Program Version 2021.2\\Advanced Photon Source\\Michael Borland, Tim Berenc\\ \date{\today}}
\maketitle
...
\begin{itemize}
\item The \verb|BGGEXP| element has four new parameters, \verb|FACTOR0|, \verb|FACTOR1|, \verb|FACTOR2|, and 
  \verb|FACTOR3|, which permit scaling the solenoidal, dipolar, quadrupolar, and sexutpolar field components
  independently.
\end{itemize}
