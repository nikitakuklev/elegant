...
offsets of the orbit are included when a particle loses energy.  To avoid unwanted quantum excitation, no longer
include offsets (i.e., dispersion effects) when tracking in with only radiation losses.
\end{itemize}
