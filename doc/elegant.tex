...
\author{Program Version 27.0.1\\Advanced Photon Source\\Michael Borland\\ \date{\today}}
\maketitle
...
\item Apertures are now disabled inside \verb|KSEXT| and \verb|KQUAD| elements that are tilted by more than 100 mrad, in order
  to avoid unexpected consequences (e.g., swapping of horizontal and vertical aperture in skew quadrupoles). This was reported by X. Neul (ESRF).
