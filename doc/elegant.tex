...
\item The \verb|WAKE|, \verb|TRWAKE|, and \verb|ZLONGIT| elements now support bunch-by-bunch calculations.
...
\item The \verb|sdds_beam| command has two new parameters, \verb|track_pages_separately| and \verb|use_bunched_mode|, which clarify the handling of multi-page
  input files and allow invoking bunched-mode calculations with \verb|LRWAKE|, \verb|WAKE|, \verb|TRWAKE|, and \verb|ZLONGIT|.
...
This includes the {\tt LRWAKE}, {\tt WAKE}, {\tt TRWAKE}, and {\tt ZLONGIT} elements.
