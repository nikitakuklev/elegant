...
\author{Program Version 2023.3\\Advanced Photon Source\\Michael Borland\\ \date{\today}}
\maketitle
...
\section{Highlights of What's New in Version 2023.3}
...
\item The \verb|insert_elements| command now supports defining the region of insertion using named elements.
\end{itemize}
...
The Poisson solver option makes use of the FFTW library (http://www.fftw.org/).  This library must be installed for the Poisson solver to work.  The Poisson equation is solved over the full \verb|ion_span|.
