...
\author{Program Version 18.1.2\\Advanced Photon Source\\Michael Borland\\ \date{\today}}
\maketitle

\section{Highlights of What's New in Version 18.1.2}
...
\item It is now possible to run in parallel mode even when the first tracking step is set to fiducialization using
 \verb|first_is_fiducial=1| in \verb|run_control|.  This was fixed by Y. Wang (APS).
