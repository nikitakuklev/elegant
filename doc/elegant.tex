...
\item The tracking used for matrix determination for elements, such as \verb|CCBEND|, \verb|BGGEXP|, and others, that rely on this,
  now takes advantage of parallel resources.
\end{itemize}
...
\item For the \verb|longitCalcs| script, the calculation of rf bucket height was incorrect when a harmonic voltage
