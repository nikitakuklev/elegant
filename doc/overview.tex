...
files}{http://www.aps.anl.gov/Accelerator_Systems_Division/Operations_Analysis/cgi-bin/oagLog4.cgi?name=elegantExamples.tar.gz}
available from our web site.

More detail as well as the most up-to-date information will be found in the 
\htmladdnormallink{manual}{https://www.aps.anl.gov/Accelerator_Systems_Division/Operations_Analysis/elegant_latest/elegant.html},
as well as the 
