...
#  if HAVE_GPU
  ...
  char *GREETING = "This is gpu-Pelegant 2023.2.0 ALPHA RELEASE, "__DATE__
...
#  else
  ...
  char *GREETING = "This is elegant 2023.2.0 "__DATE__
...
#  if HAVE_GPU
  ...
  char *GREETING = "This is gpu-elegant 2023.2.0 ALPHA RELEASE, "__DATE__
                   ", by M. Borland, K. Amyx, J. Calvey, M. Carla', N. Carmignani, AJ Dick, Z. Duan, M. Ehrlichman, L. Emery, W. Guo, J.R. King, R. Lindberg, I.V. Pogorelov, V. Sajaev, R. Soliday, Y.-P. Sun, C.-X. Wang, Y. Wang, Y. Wu, and A. Xiao.";
#  else
