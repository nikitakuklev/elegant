...
#if USE_MPI
char *USAGE="mpirun -np <number of processes> Pelegant <inputfile> [-macro=<tag>=<value>,[...]]\n\nProgram by Yusong Wang, Michael Borland. (This is version 16.1, "__DATE__".)";

char *GREETING="This is parallel elegant, by Yusong Wang, Michael Borland. (This is version 16.1, "__DATE__".)";
#else
char *USAGE="elegant <inputfile> [-macro=<tag>=<value>,[...]] [-cpuList=<number>[,<number>]]\n\nProgram by Michael Borland. (This is version 16.1, "__DATE__".)";

char *GREETING="This is elegant, by Michael Borland. (This is version 16.1, "__DATE__".)";
#endif
