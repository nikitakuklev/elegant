...
class gpu_track_through_matter_kernel
{
 ...
 gpu_track_through_matter_kernel(
                                 ...
                                 double z0, unsigned int *d_sortIndex, curandState_t *d_state) : energyDecay(energyDecay), nuclearBremsstrahlung(nuclearBremsstrahlung),
  ...
  __device__ unsigned int operator()(gpuParticleAccessor &part)
  {
    ...
    return gpu_track_through_matter_dfunc(part, energyDecay,
...
extern "C"
{
                                    ...
                                    double *probBS, double *probER, double *dGammaFactor)
  {
    ...
    double K1, Xo, probBSScatter = 0, probERScatter = 0, beta, rho;
