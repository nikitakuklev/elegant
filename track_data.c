...
PARAMETER csbend_param[N_CSBEND_PARAMS] = {
    ...
    {"EYAW", "RAD", IS_DOUBLE, PARAM_CHANGES_MATRIX, (long)((char *)&csbend_example.eyaw), NULL, 0.0, 0, "error rotation about vertical axis"},
    {"EPITCH", "RAD", IS_DOUBLE, PARAM_CHANGES_MATRIX, (long)((char *)&csbend_example.epitch), NULL, 0.0, 0, "error rotation about horizontal axis"},
