...
PARAMETER nibend_param[N_NIBEND_PARAMS] = {
    ...
    {"BOUNDARY_POSITION", "", IS_LONG, 0, (long)((char *)&nibend_example.boundaryPosition), NULL, 0.0, 0, "0=fringe centered on reference plane, -1=fringe inside, 1=fringe outside."},
    };
