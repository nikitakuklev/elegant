...
PARAMETER ilmatrix_param[N_ILMATRIX_PARAMS]={
    ...
    {"NUX2AX", "", IS_DOUBLE, PARAM_CHANGES_MATRIX, (long)((char *)&ilmatrix_example.tswax2[0]), NULL, 0.0, 0, "Second amplitude derivative of the horizontal tune wrt Ax"},
    {"NUY2AX", "", IS_DOUBLE, PARAM_CHANGES_MATRIX, (long)((char *)&ilmatrix_example.tswax2[1]), NULL, 0.0, 0, "Second amplitude derivative of the vertical tune wrt Ax"},
    {"NUX2AY", "", IS_DOUBLE, PARAM_CHANGES_MATRIX, (long)((char *)&ilmatrix_example.tsway2[0]), NULL, 0.0, 0, "Second amplitude derivative of the horizontal tune wrt Ay"},
    {"NUY2AY", "", IS_DOUBLE, PARAM_CHANGES_MATRIX, (long)((char *)&ilmatrix_example.tsway2[1]), NULL, 0.0, 0, "Second amplitude derivative of the vertical tune wrt Ay"},
    {"NUX1AX1AY", "", IS_DOUBLE, PARAM_CHANGES_MATRIX, (long)((char *)&ilmatrix_example.tswaxay[0]), NULL, 0.0, 0, "Amplitude derivative of the horizontal tune wrt Ax and Ay"},
    {"NUY1AX1AY", "", IS_DOUBLE, PARAM_CHANGES_MATRIX, (long)((char *)&ilmatrix_example.tswaxay[1]), NULL, 0.0, 0, "Amplitude derivative of the vertical tune wrt Ax and Ay"},
