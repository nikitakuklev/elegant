...
PARAMETER rfca_param[N_RFCA_PARAMS] = {
    ...
    {"FOCUS_MODEL", "", IS_STRING, 0, (long)((char *)&rfca_example.focusModel), NULL, 0.0, 0, "Neal (default) or SRS (simplified Rosenzweig/Serafini for standing wave)"},
...
PARAMETER rfcw_param[N_RFCW_PARAMS] = {
    ...
    {"FOCUS_MODEL", "", IS_STRING, 0, (long)((char *)&rfcw_example.focusModel), NULL, 0.0, 0, "Neal (default) or SRS (simplified Rosenzweig/Serafini for standing wave)"},
