...
PARAMETER bend_param[N_BEND_PARAMS] = {
    ...
    {"B1", "1/M", IS_DOUBLE, 0, (long)((char *)&bend_example.b1), NULL, 0.0, 0},
...
PARAMETER rfdf_param[N_RFDF_PARAMS] = {
    ...
    {"N_KICKS", "", IS_LONG, 0, (long)((char *)&rfdf_example.n_kicks), NULL, 0.0, 1},
...
PARAMETER twla_param[N_TWLA_PARAMS] = {
    ...
    {"CHANGE_P0", "", IS_LONG, 0, (long)((char *)&twla_example.change_p0), NULL, 0.0, 0},
    } ;
...
PARAMETER scraper_param[N_SCRAPER_PARAMS]={
    ...
    {"DIRECTION", "", IS_LONG,  0, (long)((char *)&scraper_example.direction), NULL, 0.0, -1},
    };
...
PARAMETER csbend_param[N_CSBEND_PARAMS] = {
    ...
    {"B1", "1/M", IS_DOUBLE, 0, (long)((char *)&csbend_example.b1), NULL, 0.0, 0},
...
PARAMETER csrcsbend_param[N_CSRCSBEND_PARAMS] = {
    ...
    {"SGDERIV_HALFWIDTH", "", IS_LONG, 0, (long)((char *)&csrcsbend_example.SGDerivHalfWidth), NULL, 0.0, 0},
...
PARAMETER rfmode_param[N_RFMODE_PARAMS] = {
    ...
    {"INITIAL_PHASE", "RAD", IS_DOUBLE, 0, (long)((char *)&rfmode_example.initial_phase), NULL, 0.0, 0},
    {"INITIAL_T", "S", IS_DOUBLE, 0, (long)((char *)&rfmode_example.initial_t), NULL, 0.0, 0},
...
PARAMETER trfmode_param[N_TRFMODE_PARAMS] = {
    ...
    {"DX", "M", IS_DOUBLE, 0, (long)((char *)&trfmode_example.dx), NULL, 0.0, 0},
    {"DY", "M", IS_DOUBLE, 0, (long)((char *)&trfmode_example.dy), NULL, 0.0, 0},
    };
...
PARAMETER wake_param[N_WAKE_PARAMS] = {
    ...
    {"FACTOR", "C", IS_DOUBLE, 0, (long)((char *)&wake_example.factor), NULL, 1.0, 0},
...
PARAMETER trwake_param[N_TRWAKE_PARAMS] = {
    ...
    {"FACTOR", "C", IS_DOUBLE, 0, (long)((char *)&trwake_example.factor), NULL, 1.0, 0},
