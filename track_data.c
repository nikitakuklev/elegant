...
PARAMETER ionEffects_param[N_IONEFFECTS_PARAMS] = {
    ...
    {"X_RANGE_MULTIPLIER", "", IS_DOUBLE, 0, (long)((char *)&ionEffects_example.rangeMultiplier[0]), NULL, 0.0, 0, "If positive, gives the ratio of ion binning region size to ion distribution sigma for ion field calculation."},
    {"Y_RANGE_MULTIPLIER", "", IS_DOUBLE, 0, (long)((char *)&ionEffects_example.rangeMultiplier[1]), NULL, 0.0, 0, "If positive, gives the ratio of ion binning region size to ion distribution sigma for ion field calculation."},
