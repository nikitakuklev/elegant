...
PARAMETER ccbend_param[N_CCBEND_PARAMS] = {
    ...
    {"OPTIMIZE_TRAJECTORY", "", IS_SHORT, 0, (long)((char *)&ccbend_example.optimizeTrajectory), NULL, 0.0, 1, "Optimize strength and x offset to obtain the ideal deflection angle and end point."},
