...
PARAMETER hmon_param[N_HMON_PARAMS] = {
    ...
    {"STORE_TURN_BY_TURN", "", IS_SHORT, 0, (long)((char *)&hmon_example.storeTurnByTurn), NULL, 0.0, 0, "If nonzero, then turn-by-turn horizontal position readout is placed in variable <name>\\#<occurence>.x."},
    } ;
...
PARAMETER vmon_param[N_VMON_PARAMS] = {
    ...
    {"STORE_TURN_BY_TURN", "", IS_SHORT, 0, (long)((char *)&vmon_example.storeTurnByTurn), NULL, 0.0, 0, "If nonzero, then turn-by-turn vertical position readout is placed in variable <name>\\#<occurence>.y."},
    } ;
...
PARAMETER moni_param[N_MONI_PARAMS] = {
    ...
    {"STORE_TURN_BY_TURN", "", IS_SHORT, 0, (long)((char *)&moni_example.storeTurnByTurn), NULL, 0.0, 0, "If nonzero, then turn-by-turn horizontal/vertical position readouts are placed in variable <name>\\#<occurence>.x/y."},
    } ;
...
PARAMETER malign_param[N_MALIGN_PARAMS] = {
    ...
    {"FLOOR", "", IS_LONG, 0, (long)((char *)&malign_example.floor), NULL, 0.0, 0, "if non-zero, floor coordinates are changed, which is probably a bad idea"},
    } ;
...
PARAMETER csbend_param[N_CSBEND_PARAMS] = {
    ...
    {"XKICK", "RAD", IS_DOUBLE, PARAM_CHANGES_MATRIX, (long)((char *)&csbend_example.xKick), NULL, 0.0, 0, "horizontal steering angle (approximate)"},
    {"YKICK", "RAD", IS_DOUBLE, PARAM_CHANGES_MATRIX, (long)((char *)&csbend_example.yKick), NULL, 0.0, 0, "vertical steering angle (approximate)"},
