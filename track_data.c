...
PARAMETER rfca_param[N_RFCA_PARAMS] = {
    ...
    {"BODY_FOCUS_MODEL", "", IS_STRING, 0, (long)((char *)&rfca_example.bodyFocusModel), NULL, 0.0, 0, "None (default) or SRS (simplified Rosenzweig/Serafini for standing wave)"},
...
PARAMETER rfcw_param[N_RFCW_PARAMS] = {
    ...
    {"BODY_FOCUS_MODEL", "", IS_STRING, 0, (long)((char *)&rfcw_example.bodyFocusModel), NULL, 0.0, 0, "None (default) or SRS (simplified Rosenzweig/Serafini for standing wave)"},
