...
ELEMENT_DESCRIPTION entity_description[N_TYPES] = {
    ...
    { N_TRCOUNT_PARAMS,           UNIPROCESSOR,    sizeof(TRCOUNT),    trcount_param  },
    ...
    { N_HISTOGRAM_PARAMS, 0|UNIPROCESSOR, sizeof(HISTOGRAM), histogram_param},
    ...
    { N_TFBDRIVER_PARAMS,         UNIPROCESSOR,     sizeof(TFBDRIVER),  tfbdriver_param    },
