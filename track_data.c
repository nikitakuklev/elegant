...
PARAMETER ionEffects_param[N_IONEFFECTS_PARAMS] = {
    ...
    {"X_BINS", "", IS_DOUBLE, 0, (long)((char *)&ionEffects_example.ionBins[0]), NULL, 0.0, 0, "If positive, gives the number of bins over +/-X_SPAN for computation of ion fields."},
    {"Y_BINS", "", IS_DOUBLE, 0, (long)((char *)&ionEffects_example.ionBins[1]), NULL, 0.0, 0, "If positive, gives the number of bins over +/-Y_SPAN for computation of ion fields."},
