...
PARAMETER lsrMdltr_param[N_LSRMDLTR_PARAMS] = {
    ...
    {"LASER_M", "", IS_LONG, 0, (long)((char *)&lsrMdltr_example.laserM), NULL, 0.0, 0, "laser horizontal mode number"},
    {"LASER_N", "", IS_LONG, 0, (long)((char *)&lsrMdltr_example.laserN), NULL, 0.0, 0, "laser vertical mode number"},
