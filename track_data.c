...
ELEMENT_DESCRIPTION entity_description[N_TYPES] = {
    ...
    {    N_RFCA_PARAMS,     MAT_LEN_NCAT|HAS_RF_MATRIX|MAY_CHANGE_ENERGY|UNIPROCESSOR,       sizeof(RFCA),    rfca_param     }, 
    {                0,           0,                  0,    NULL           },
    ...
    {    N_MARK_PARAMS,           0|UNIDIAGNOSTIC,       sizeof(MARK),    mark_param     }, 
    ...
    {    N_RFDF_PARAMS,  MAT_LEN_NCAT|UNIPROCESSOR,       sizeof(RFDF),    rfdf_param     }, 
    {    N_RFTMEZ0_PARAMS,  MAT_LEN_NCAT|MAY_CHANGE_ENERGY|UNIPROCESSOR,    sizeof(RFTMEZ0),    rftmez0_param     }, 
    ...
    {   N_WATCH_PARAMS,  UNIDIAGNOSTIC|RUN_ZERO_PARTICLES,      sizeof(WATCH),    watch_param    }, 
    ...
    {    N_TWLA_PARAMS,  MAT_LEN_NCAT|MAY_CHANGE_ENERGY|UNIPROCESSOR,   sizeof(TW_LINAC),    twla_param     },
    {  N_PEPPOT_PARAMS,  MAT_LEN_NCAT,     sizeof(PEPPOT),    peppot_param   },
    {  N_ENERGY_PARAMS,           UNIPROCESSOR,     sizeof(ENERGY),    energy_param   },
    ...
    {  N_RAMPRF_PARAMS, MAT_LEN_NCAT|HAS_RF_MATRIX|MAY_CHANGE_ENERGY|UNIPROCESSOR,    sizeof(RAMPRF),    ramprf_param   },
    ...
    {  N_RFMODE_PARAMS,          UNIPROCESSOR,      sizeof(RFMODE),   rfmode_param    },
    { N_TRFMODE_PARAMS,          UNIPROCESSOR,     sizeof(TRFMODE),  trfmode_param    },
    { N_ZLONGIT_PARAMS,          UNIPROCESSOR,     sizeof(ZLONGIT),  zlongit_param    },
    { N_SREFFECTS_PARAMS,        UNIPROCESSOR,   sizeof(SREFFECTS),  sreffects_param  },
    { N_MODRF_PARAMS, MAT_LEN_NCAT|HAS_RF_MATRIX|MAY_CHANGE_ENERGY|UNIPROCESSOR,       sizeof(MODRF),    modrf_param     }, 
    { N_BMAPXY_PARAMS,     HAS_LENGTH,   sizeof(BMAPXY),  bmapxy_param      },
    { N_ZTRANSVERSE_PARAMS,          UNIPROCESSOR,     sizeof(ZTRANSVERSE),  ztransverse_param    },
    { N_IBSCATTER_PARAMS,        0,   sizeof(IBSCATTER),  ibscatter_param  },
    { N_FMULT_PARAMS,  MAT_LEN_NCAT|IS_MAGNET,       sizeof(FMULT),    fmult_param     }, 
    { N_WAKE_PARAMS, MAY_CHANGE_ENERGY|UNIPROCESSOR, sizeof(WAKE), wake_param},
    ...
    {  N_CSRDRIFT_PARAMS, MAT_LEN_NCAT|UNIPROCESSOR,
       sizeof(CSRDRIFT),    csrdrift_param   },
    {  N_RFCW_PARAMS,     MAT_LEN_NCAT|HAS_RF_MATRIX|MAY_CHANGE_ENERGY|UNIPROCESSOR,
    ...
    { N_CLEAN_PARAMS,  UNIPROCESSOR, sizeof(CLEAN), clean_param },
    { N_TWISSELEMENT_PARAMS, HAS_MATRIX|MATRIX_TRACKING|UNIPROCESSOR, 
    ...
    {  N_FRFMODE_PARAMS,         UNIPROCESSOR,      sizeof(FRFMODE),   frfmode_param    },
    { N_FTRFMODE_PARAMS,         UNIPROCESSOR,     sizeof(FTRFMODE),  ftrfmode_param    },
    ...
    { N_LSCDRIFT_PARAMS, MAT_LEN_NCAT|UNIPROCESSOR,     sizeof(LSCDRIFT),  lscdrift_param    },
