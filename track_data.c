...
PARAMETER ksext_param[N_KSEXT_PARAMS] = {
    ...
    {"MIN_MULTIPOLE_ORDER", "", IS_SHORT, 0, (long)((char *)&ksext_example.minMultipoleOrder), NULL, 0.0, -1, "If nonnegative, minimum order of systematic and random multipoles to use from data files."},
    {"MAX_MULTIPOLE_ORDER", "", IS_SHORT, 0, (long)((char *)&ksext_example.maxMultipoleOrder), NULL, 0.0, -1, "If nonnegative, inimum order of systematic and random multipoles to use from data files."},
...
PARAMETER kquad_param[N_KQUAD_PARAMS]={
    ...
    {"MIN_MULTIPOLE_ORDER", "", IS_SHORT, 0, (long)((char *)&kquad_example.minMultipoleOrder), NULL, 0.0, -1, "If nonnegative, minimum order of systematic and random multipoles to use from data files."},
    {"MAX_MULTIPOLE_ORDER", "", IS_SHORT, 0, (long)((char *)&kquad_example.maxMultipoleOrder), NULL, 0.0, -1, "If nonnegative, inimum order of systematic and random multipoles to use from data files."},
...
PARAMETER ccbend_param[N_CCBEND_PARAMS] = {
    ...
    {"MIN_MULTIPOLE_ORDER", "", IS_SHORT, 0, (long)((char *)&ccbend_example.minMultipoleOrder), NULL, 0.0, -1, "If nonnegative, minimum order of systematic and random multipoles to use from data files."},
    {"MAX_MULTIPOLE_ORDER", "", IS_SHORT, 0, (long)((char *)&ccbend_example.maxMultipoleOrder), NULL, 0.0, -1, "If nonnegative, inimum order of systematic and random multipoles to use from data files."},
