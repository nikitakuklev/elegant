...
static SDDS_DEFINITION column_definition[N_COLUMNS] = {
  ...
  {"xAperture", "&column name=xAperture, type=double, symbol=\"a$bx$n\", description=\"Horizontal aperture\" &end"},
  ...
  {"yAperture", "&column name=yAperture, type=double, symbol=\"a$by$n\", description=\"Vertical aperture\" &end"},
