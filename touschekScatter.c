...
*/
          ...
          chprint1(lossDis, tsptr->outFile, "Beam loss distribution in particles/s/sbin_step(m) for particles scattered between i-1 and i TSCATTER elements", "particles/s/sbin_step(m)", NULL,
